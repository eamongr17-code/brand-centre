      ...
      {block.colours.map((c, i) => {
        ...
        return (
          <button
            ...
            className="group flex items-center gap-3 bg-white/[0.02] border border-white/[0.06] rounded-xl px-4 py-3 hover:border-white/[0.12] transition-all duration-200"
          >
            <div
            ...
            <div className="text-left">
              <p className="text-sm font-semibold text-[#ececec]">{c.name}</p>

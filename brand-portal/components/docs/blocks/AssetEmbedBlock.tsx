...
export default function AssetEmbedBlock({ block }: { block: AssetEmbedBlockType }) {
  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] overflow-hidden hover:border-white/[0.12] transition-all duration-200">
      <div className="flex items-center gap-4 p-4">
        <div className="w-16 h-16 rounded-lg overflow-hidden bg-white/[0.02] border border-white/[0.04] shrink-0">
          <FadeImg
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-[#ececec] truncate">{asset.name}</p>
          {asset.description && (

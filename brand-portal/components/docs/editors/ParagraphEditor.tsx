  ...
  return (
    <div className="space-y-2">
      <textarea
        ...
        className="w-full bg-white/[0.04] border border-white/[0.08] rounded-lg px-3 py-2 text-sm text-[#ececec] placeholder-[#444] focus:outline-none focus:border-white/[0.15] resize-none"
        rows={4}
